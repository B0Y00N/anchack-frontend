...
const routes = [
  ...
  { path: "/login", name: "login", component: () => import("../user/views/AuthView.vue"), meta: { guestOnly: true } },
  { path: "/signup", name: "signup", component: () => import("../user/views/AuthView.vue"), meta: { guestOnly: true } },
